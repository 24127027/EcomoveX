...
@router.get("/direct-rooms", response_model=list[DirectRoomResponse], status_code=status.HTTP_200_OK)
...
@router.get("/direct-rooms/{direct_room_id}", response_model=DirectRoomResponse, status_code=status.HTTP_200_OK)
