...
from schemas.room_schema import RoomCreate, RoomResponse, AddMemberRequest, RemoveMemberRequest
...
@router.post("/{room_id}/members", response_model=RoomResponse, status_code=status.HTTP_200_OK)
...
@router.delete("/{room_id}/members", response_model=RoomResponse, status_code=status.HTTP_200_OK)
