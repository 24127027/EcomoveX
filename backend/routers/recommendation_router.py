...
async def get_recommendations_for_user(
    ...
    return await RecommendationService.recommend_for_user(db, user_id, k=k, use_hybrid=use_hybrid)
...
async def get_similarity_recommendations_for_cluster(
    ...
    return await RecommendationService.recommend_for_cluster_similarity(db, cluster_id, k=k)
