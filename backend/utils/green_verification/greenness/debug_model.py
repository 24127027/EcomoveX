...
if __name__ == "__main__":
    ...
    if os.path.exists(img_path):
        ...
        results = model.predict(img_path, conf=0.05, save=True, project=current_dir, name="test_result", exist_ok=True)
        ...
        if len(result) > 0:
            ...
            print("👉 KẾT LUẬN: Model 'best.pt' này train không tốt hoặc không phù hợp với ảnh cây cảnh này.")
            print("💡 GIẢI PHÁP: Bạn nên thử dùng model chuẩn 'yolov8n-seg.pt' để test xem code có lỗi không.")
