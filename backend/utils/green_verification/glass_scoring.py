...
class CupDetectorScorer:
    ...
    def __init__(
        ...
        """
        Args:
            model_path: path to YOLO model. Defaults to glass_classification_model.pt in same directory.
        ...
        # compute default model path if not provided
...
if __name__ == "__main__":
    script_dir = os.path.dirname(os.path.abspath(__file__))
    model_path = os.path.join(script_dir, "glass_classification_model.pt")
