...
from sqlalchemy import Column, Date, DateTime, Enum as SQLEnum, Float, ForeignKey, Index, Integer, PrimaryKeyConstraint, String, Text, func
...
class PlanMember(Base):
    ...
    __table_args__ = (
        Index('ix_plan_member_role', 'plan_id', 'role'),
    )
