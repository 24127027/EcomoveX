...
class Destination(Base):
    ...
    __table_args__ = (
        Index('ix_destination_green_verified', 'green_verified'),
    )
    ...
    embedding = relationship("DestinationEmbedding", back_populates="destination", uselist=False)

class DestinationEmbedding(Base):
    __tablename__ = "destination_embeddings"
    __table_args__ = (
        Index('ix_embedding_model_version', 'model_version'),
    )
